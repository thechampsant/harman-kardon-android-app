...
import com.suveyform.view_models.SurveyFormHistoryViewModel;
...
public class CoronaSurveyPastDataFragment extends IFragment {
    ...
    private SurveyFormHistoryViewModel mViewModel;
    ...
    private void initWidgets(){
        mViewModel = ViewModelProviders.of(getActivity()).get(SurveyFormHistoryViewModel.class);
