...
{
    private static final String TAG = "CoronaSurveyViewModelO";
    ...
    public LiveData<Resource<CoronaSurveyQuestionResponseContainer>> observeResponse(){
        if (responseFromWebWhenGettingQuestions ==null){
            ...
            final LiveData<Resource<CoronaSurveyQuestionResponseContainer>> source = LiveDataReactiveStreams.fromPublisher(
                    ServiceGenerator.getCoronaSurveyApi1().getSurveyQuestions(MainActivity.MyInfo.UserID.toString())
    ...
    public void submitAnswersToServer(String SDAte, String questionsIds, String answers)
    {
            ...
            final LiveData<Resource<CoronaSurveyAnswerResponseContainer>> source = LiveDataReactiveStreams.fromPublisher(
                    ServiceGenerator.getCoronaSurveyApi1().submitCoronaSurveyAnswersToServer(SDAte,questionsIds,answers, MainActivity.MyInfo.UserID.toString())
                            .subscribeOn(Schedulers.io())
