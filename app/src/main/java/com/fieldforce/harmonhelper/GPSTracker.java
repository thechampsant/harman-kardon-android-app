...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static final long MIN_DISTANCE_CHANGE_FOR_UPDATES = 10 * 0; // 0 meters
    ...
    //GpsResult CallBack for
    GpsResultCallBack mLocationCallback;
    ...
    public void setLocationcallBack(GpsResultCallBack callBack) {
    ...
    public void onLocationChanged(Location _location) {
        if (mLocationCallback != null)
            mLocationCallback.onLocationChange(_location.getLongitude(), _location.getLatitude());
        location = _location;
    }
