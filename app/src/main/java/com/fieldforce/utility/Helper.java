...
public class Helper {
    ...
    public static void openNextActivity(Activity context, Class coronaSurvey_tabsClass, Bundle bundle, boolean forResult, int reqCode) {
        Intent intent = new Intent(context, coronaSurvey_tabsClass);
        if (bundle != null) {
