...
public class ViewDemoFragment extends IFragment {
    ...
    private ViewDemoRecyclerAdapter mAdapter;
    public ViewDemoFragment() {

    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return this.InflateView(R.layout.fragment_view_demo_tracking, inflater, container);
    }
    ...
    private void init(){
        ...
        mAdapter = new ViewDemoRecyclerAdapter();
                ...
                .setHorizantalScreenProgress().setbackgroundProcess(
                        new IProcess() {
                            ...
                            public Object underProcess() throws Exception {
                                // TODO Auto-generated method stub
                                return webapi.getDemoDataFromServer(startDate, endDate);
                            }
                            ...
                            public void processResponse(Object response)
                                ...
                                if (resp.isSuccess())
                                {
                                    if (resp.status.equalsIgnoreCase("true")){
                                        ...
                                        ArrayList<ViewDemoResponseModel> dataList = resp.data;
