...
public class ViewDownStock extends IFragment {
    ...
    private ViewDownStockAdpter mAdapter;
    ...
    private void init(){
        ...
        mAdapter = new ViewDownStockAdpter();
    ...
    private void hitapi(final String start, final String end) {
        ...
        BackgroundProcess bp = new BackgroundProcess(getActivity()).showProgress(false);
        bp.setbackgroundProcess(
                new IProcess() {
                    ...
                    public Object underProcess() throws Exception {
                        // TODO Auto-generated method stub
                        return webapi.ViewDownStock(startDate, endDate);
                    }
