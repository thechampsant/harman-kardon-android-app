...
public class CoronaSurveyAnswerResponseContainer {
    ...
    @SerializedName("data")
    @Expose
    private CoronaSurveyAnswerSubmissionResponse data = null;
    ...
    public CoronaSurveyAnswerSubmissionResponse getData() {
        return data;
    }

    public void setData(CoronaSurveyAnswerSubmissionResponse data) {
        this.data = data;
    }
