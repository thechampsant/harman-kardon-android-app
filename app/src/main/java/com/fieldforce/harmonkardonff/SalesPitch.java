...
public class SalesPitch extends InnosolsActivity {
    ...
    {
        if (server.isNetworkAvailable(SalesPitch.this))
        {
            new SalesPitch.RequestForIncentive().execute((Void) null);
    ...
    public class RequestForIncentive extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            try {
                mDialog = ProgressDialog.show(SalesPitch.this, "", "Please wait..");
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                resTargetVsAchivement = server.GetSchemes("SalePic");
