...
public class TargetScreenManagerQTYActivity extends InnosolsActivity {
    ...
    private TargetScreenManagerAdpterQTY adapter;
    ...
    public class AllTarget extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            try {
                mDialog = ProgressDialog.show(TargetScreenManagerQTYActivity.this,
                        "", "Please wait..");
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                if (server.isNetworkAvailable(TargetScreenManagerQTYActivity.this))
                    resTargetVsAchivement = server.getTargetAchievementFromWebQTY();
                else {
    ...
    private void setupRecycler() {
        adapter = new TargetScreenManagerAdpterQTY();
