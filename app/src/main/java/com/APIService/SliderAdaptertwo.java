...
public class SliderAdaptertwo extends SliderViewAdapter<SliderAdaptertwo.SliderAdapterViewHolder> {
    // list for storing urls of images.
    private final int[] mSliderItems;
    Context context;

    // Constructor
    public SliderAdaptertwo(Context context, int[] sliderDataArrayList) {
