 ...
 *
 */
public class MDisplay extends DataEntity<MDisplay>{
	
	/**
	 * @param _Name
	 */
	static String TableName="MDisplay";
	public MDisplay() {
		super(TableName);
	...
	public void RegisterMappings() {
		...
		this.RegisterMapping("Brand",DataTypes.TEXT);
